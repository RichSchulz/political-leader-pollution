...
- Autocracy-only first stage (`v2x_polyarchy < 0.3`) does not rescue the nightlights result: in the DMSP `1992-2013` window, Lag 0 = `0.0111` (`p=0.574`); in the DMSP `2005-2013` window, Lag 0 = `0.0076` (`p=0.552`). Results are saved in `data/autocracy_first_stage_results.csv`.
