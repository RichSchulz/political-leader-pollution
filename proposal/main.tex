...
\begin{itemize}
    \item Data acquisition and processing (Google Earth Engine, GADM matching, panel construction): \textit{TBD}
    \item Econometric analysis and regression implementation: \textit{TBD}
    \item Literature review and related work write-up: \textit{TBD}
    \item Robustness checks and heterogeneity analyses: \textit{TBD}
