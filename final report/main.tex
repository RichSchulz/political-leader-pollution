...
\significancestatement{Birth regions of national leaders grow brighter while in office, and the growth is less pollution-intensive than activity elsewhere. Using a harmonized 2005--2017 panel, we find a nightlights coefficient of 0.049 ($p = 0.001$), an NO$_2$ intensity coefficient of $-0.039$ ($p = 0.044$), and a PM$_{2.5}$ intensity coefficient of $-0.044$ ($p = 0.004$). Birth regions grow brighter without a proportional rise in measured air pollution; this is a relative shift in the pollution-to-nightlights ratio, not direct evidence of abatement. An event study with 120 balanced spells shows flat NO$_2$-intensity pre-trends and a negative coefficient at $t+2$. The effect is substantially stronger in Sub-Saharan Africa than elsewhere, and globally the activity coefficient is about three times larger in mineral-rent economies, suggestive of a composition channel in which leaders direct large public works funded by resource rents toward birth regions, though the satellite design cannot separate composition from selective enforcement or sorting.}
...
An event study with a balanced $\pm 3$-year window around leader entry (120 spells, entry 2008--2016) provides the timing evidence and the parallel-trends test. Pre-trends for NO$_2$ intensity at $t=-3$ and $t=-2$ are statistically insignificant; this is consistent with parallel trends for NO$_2$ intensity, though two insignificant leads in a balanced sample of 120 spells have limited power and are not strong proof. NTL and PM$_{2.5}$-intensity pre-trends are significant. For NTL, the pre-trend means birth regions were already on a different growth trajectory in the years before leader entry, so the event study does not support a clean causal interpretation for nightlights on its own; for PM$_{2.5}$ intensity, the pre-trend cannot be explained mechanically by activity differences (because intensity already differences out nightlights), so the PM$_{2.5}$ event-study coefficients should be interpreted more cautiously than the NO$_2$ ones. The NO$_2$-intensity coefficient becomes negative and statistically significant at $t+2$ ($-0.110^*$) and attenuates by $t+3$.
...
The two pollution indicators are complementary rather than interchangeable. The NO$_2$-intensity estimate is sensitive to country-level clustering and loses statistical significance under that more conservative scheme (Table~\ref{tab:cluster-robustness}), while the PM$_{2.5}$-intensity estimate is more stable. Conversely, the NO$_2$-intensity event study has the cleaner pre-trends (Section~4), while the PM$_{2.5}$ event-study pre-trends warrant caution. PM$_{2.5}$ captures a broader mix of emission sources including transportation and combustion, while NO$_2$ is more specific to traffic and industrial combustion.
...
The NO$_2$-intensity panel provides the cleanest event-study evidence. Pre-trend coefficients at $t=-3$ and $t=-2$ are close to zero and neither is statistically significant, consistent with parallel trends for NO$_2$ intensity, though the balanced sample of 120 spells has limited power. The NO$_2$-intensity coefficient becomes negative and statistically significant at $t+2$ ($-0.110^*$) and attenuates by $t+3$. The NTL panel shows significant pre-trends at $t=-3$ and $t=-2$. Because event-study leads measure differential trends relative to $t=-1$, not differences in baseline levels (which the ADM2 fixed effects already absorb), the NTL pre-trends indicate that birth regions were already on a different growth trajectory before leader entry. The event study therefore does not support a clean causal interpretation for the nightlights outcome on its own; we read the NTL favoritism result as a robust descriptive pattern, and rely on the NO$_2$-intensity event study for the cleaner timing evidence. The PM$_{2.5}$-intensity panel also shows differential pre-trends; this cannot be explained mechanically by activity differences, since intensity differences out the nightlights component, so the PM$_{2.5}$ event-study estimates should be interpreted more cautiously than the NO$_2$ ones. PM$_{2.5}$ intensity remains the more robust outcome under conservative country-level inference (Table~\ref{tab:cluster-robustness}); the two indicators are complementary rather than interchangeable.
...
The green favoritism result is substantially stronger in Sub-Saharan Africa than elsewhere, though it is not absent outside SSA. Table~\ref{tab:ssa-decomp} decomposes the 2005--2017 nightlights effect by region. The SSA coefficient is 0.109 ($p = 0.017$, $N = 56{,}589$), roughly three times the non-SSA estimate of 0.033 ($p = 0.026$, $N = 566{,}279$) and about 2.2 times the pooled estimate of 0.049. The non-SSA coefficient is itself positive and statistically significant; SSA is the more pronounced case rather than the only one. The SSA pollution-intensity estimates are also larger in magnitude: NO$_2$ intensity at $-0.106$ (SE = 0.051, $p = 0.042$) and PM$_{2.5}$ intensity at $-0.112$ (SE = 0.044, $p = 0.013$). Because satellite measurement error may differ across SSA and non-SSA settings, especially in low-light districts and large ADM2 polygons, the larger SSA coefficients should be interpreted cautiously.
