...
The contribution relative to recent replication work is therefore diagnostic. Recent work with expanded birthplace data and harmonized nightlights also finds a positive pooled favoritism effect in extended samples \cite{Bora2025, DubenHodlerRaschky2026}. By contrast, we focus on the temporal pattern inside later annual windows, show that the break starts within DMSP before any sensor switch, isolate the long-run Sub-Saharan African historical core, and evaluate whether a shift toward cleaner growth can explain the weaker activity effect. The result is not that the historical finding disappears in all data. It is that the later-period relationship is unstable: it peaks in the late 2000s, weakens sharply by the early 2010s, and is not restored by post-2005 subsample cuts or by standalone VIIRS data.
...
That temporal pattern points away from a simple harmonization story and toward changes in the underlying political or measurement environment. Several mechanisms remain plausible. One is that the late-2000s peak partly reflects the commodity-cycle period and unusually strong distributive scope in some leader spells. Another is that transparency and monitoring increased in the 2010s, making geographically concentrated favoritism harder to sustain. A third is weaker political support from shorter observed spells, though that comparison is partly mechanical in narrower windows. We also see signs of reduced luminosity headroom in later DMSP years, but the subsample tests dropping high-luminosity districts do not recover the effect. These results narrow the candidate explanations, but do not identify one of them decisively.
