...
Political leaders often direct resources toward their home regions, a pattern documented in cross-country evidence using subnational nightlights \cite{HodlerRaschky2014}. This paper studies how strongly that result appears in later annual windows. The post-2005 years are especially useful for that question because they overlap with harmonized nightlights and global pollution measures. They are also exactly where the canonical birth-region activity effect becomes much harder to detect.

This paper documents that attenuation and asks what it implies. In the long DMSP window, the lag-0 birth-region coefficient is positive and statistically significant. In 2005--2013, still within DMSP, and in harmonized 2005--2019, the point estimates are much smaller and statistically uninformative. The attenuation is not confined to one endpoint choice. It also survives targeted cuts by geography, leader tenure, autocracy, luminosity headroom, and pollution-support samples.
